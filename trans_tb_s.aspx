    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function q_seekStr() {
                ...
                if(t_tre=='Y'){
                    t_where +="and( exists(select view_tres.noa from view_tres"+ 
                    " left join calctypes on calctypes.noa+calctypes.noq= trans"+r_accy+".calctype"+
                    " where calctypes.isoutside=1 and view_tres.tranno=trans"+r_accy+".noa)"+
                ...
                if(t_tre=='N'){
                    t_where +="and not(exists(select view_tres.noa from view_tres"+ 
                    " left join calctypes on calctypes.noa+calctypes.noq= trans"+r_accy+".calctype"+
                    " where calctypes.isoutside=1 and view_tres.tranno=trans"+r_accy+".noa)"+
                    " or exists(select carsal.noa from carsal"+
                    " left join calctypes on calctypes.noa+calctypes.noq= trans"+r_accy+".calctype"+
